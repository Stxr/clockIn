...
package com.stxr.clockin.utils.clusterutil.clustering.view;
...
import  com.stxr.clockin.utils.clusterutil.MarkerManager;
...
import  com.stxr.clockin.utils.clusterutil.projection.Point;
import  com.stxr.clockin.utils.clusterutil.projection.SphericalMercatorProjection;
import com.stxr.clockin.utils.clusterutil.ui.IconGenerator;
...
import static com.stxr.clockin.utils.clusterutil.clustering.algo.NonHierarchicalDistanceBasedAlgorithm.MAX_DISTANCE_AT_ZOOM;
...
public class DefaultClusterRenderer<T extends ClusterItem> implements
        com.stxr.clockin.utils.clusterutil.clustering.view.ClusterRenderer<T> {
    ...
    private com.stxr.clockin.utils.clusterutil.ui.SquareTextView makeSquareTextView(Context context) {
        com.stxr.clockin.utils.clusterutil.ui.SquareTextView squareTextView =
                new com.stxr.clockin.utils.clusterutil.ui.SquareTextView(context);
